...
const Search = ({allproducts, setSearchData}) => {
    ...
    const update = (event) => { 
        const result = allproducts.filter(product => product.name.toLowerCase().includes(searchVal.toLowerCase()));
            ...
            <div className="input-group"
                ...
                <Overlay show={show}
                    ...
                    <Popover id="popover-contained"
                        ...
                        <Popover.Header as="h3">No results found for that term, please try again.</Popover.Header>
                    </Popover>
                </Overlay>
                <SearchButton/>
            </div>
